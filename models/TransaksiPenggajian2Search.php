...
/**
 * TransaksiPenggajian2Search represents the model behind the search form about `app\models\TransaksiPenggajian`.
 */
class TransaksiPenggajian2Search extends TransaksiPenggajian
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['transgaji_id', 'data_id', 'pelaksana_id'], 'integer'],
            [['nomor_transgaji', 'tgl_gaji', 'tgl_input'], 'safe'],
