    ...
    [
        ...
        'buttons' => [
            'view' => function ($url, $model) {
                ...
                $t = '@web/transaksi-penggajian/view?id=' . $model->transgaji_id;
            ...
            'update' => function ($url, $model) {
                $idmodal = md5($model::className());
                $t = '@web/transaksi-penggajian/update?id=' . $model->transgaji_id;
            ...
            'delete' => function ($url, $model) {
                $idmodal = md5($model::className());
                $t = '@web/transaksi-penggajian/delete?id=' . $model->transgaji_id;
