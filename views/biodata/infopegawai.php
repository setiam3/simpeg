    ...
    <div class="col-md-9">
        ...
        echo Tabs::widget([
            'items' => [
                ...
                [
                    'label' => 'Diklat',
                    'content' => $this->render('//riwayatdiklat/index', ['searchModel' => $searchModeldiklat, 'dataProvider' => $searchModeldiklat->search(Yii::$app->request->queryParams, ['id_data' => $model->id_data])]),
                ],
                [
                    'label' => 'Pendidikan',
