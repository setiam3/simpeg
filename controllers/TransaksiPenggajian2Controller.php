...
use app\models\TransaksiPenggajian2Search;
...
/**
 * TransaksiPenggajian2Controller implements the CRUD actions for TransaksiPenggajian model.
 */
class TransaksiPenggajian2Controller extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new TransaksiPenggajian2Search();
        ...
        if ($request->isAjax) {
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->transgaji_id]);
            } else {
